...
const OrganizationSchema = () => {
  const organizationSchema = {
    ...
    "description": "Comprehensive directory of Greek beaches with detailed information about amenities, accessibility, and conditions. Find the perfect beach in Greece for your next visit.",
    "foundingDate": "2024",
    "sameAs": [
    ...
    "owns": {
      ...
      "description": "Comprehensive database of beaches across Greece including location, amenities, conditions, and accessibility information",
  ...
  const websiteSchema = {
    ...
    "name": "Beaches of Greece",
    "url": "https://beachesofgreece.com",
    "description": "Find Greek beaches near you or by area—filter Blue Flag, parking, beach bars, toilets, wave conditions, and sand type. Plan your day in minutes.",
    "potentialAction": {
      "@type": "SearchAction",
      "target": {
        "@type": "EntryPoint",
