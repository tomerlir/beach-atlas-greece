...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "When we show you beach recommendations, we explain exactly why each beach matches your search. For example, if you search for 'calm sandy beach with parking', we'll show you a summary like 'Showing 12 beaches: sandy beaches (all), calm waters (all), parking available (all)'. This transparency helps you understand that the results are based on verified data, not hidden algorithms or paid placements."
    },
    {
      question: "Do you include accessibility information?",
      answer: "Yes, we track accessibility features where available, including wheelchair access, accessible toilets, beach wheelchairs (wheelchairs designed for sand/water), and paved pathways to the beach. However, accessibility data is still being expanded across our database. If you have accessibility information about a beach, please share it with us at info@beachesofgreece.com."
    },
    {
      question: "Can I share specific beach recommendations with friends?",
      answer: "Yes! Each beach detail page has a Share button that lets you copy a direct link or share via social media. You can also share filtered search results by copying the URL from your browser - it preserves your search criteria and filters, making it easy to recommend beaches that match specific preferences."
    }
  ];

  // Generate SEO data
  const seoTitle = "Frequently Asked Questions | Beaches of Greece";
  const seoDescription = "Find answers to common questions about using Beaches of Greece, understanding beach features, data accuracy, Blue Flag certification, and more.";
