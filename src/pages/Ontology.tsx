...
const Ontology = () => {
  ...
  const seoDescription = "Official definitions for beach data fields tracked by Beach Atlas Greece. Understand how we model beaches as structured data for explainable matches.";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground mb-6">
                We model beaches as structured data so travelers can get explainable matches. 
                This page defines the fields we verify and how we interpret them.
              </p>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Official beach name as recognized locally</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Area</h4>
                      <p className="text-gray-600 text-sm">Geographic region or island where the beach is located</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Coordinates</h4>
                      <p className="text-gray-600 text-sm">Latitude and longitude for precise location mapping</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Description</h4>
                      <p className="text-gray-600 text-sm">Detailed description of the beach's characteristics and appeal</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Classification: Sandy, Pebbly, Mixed, or Other</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Wave Conditions</h4>
                      <p className="text-gray-600 text-sm">Typical wave intensity: Calm, Moderate, Wavy, or Surfable</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Organization Level</h4>
                      <p className="text-gray-600 text-sm">Whether the beach has organized facilities (sunbeds, umbrellas, services)</p>
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900">Blue Flag Certification</h4>
                      <p className="text-gray-600 text-sm">International environmental certification for water quality and safety</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Parking availability: None, Roadside, Small lot, or Large lot</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div key={amenity.id} className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600 mt-1">
                            ...
                            {amenity.id === 'umbrellas' && 'Shade umbrellas available for rent or use'}
                            {amenity.id === 'parking' && 'Vehicle parking facilities near the beach'}
                            {amenity.id === 'showers' && 'Freshwater shower facilities for rinsing off'}
                    ...
                    {safety.map((amenity) => (
                      <div key={amenity.id} className="flex items-start">
                        ...
                        <div>
                          <span className="text-sm font-medium text-gray-900">{amenity.label}</span>
                          <p className="text-xs text-gray-600 mt-1">
                            {amenity.id === 'lifeguard' && 'Professional lifeguard services during operating hours'}
                          </p>
                        </div>
                      </div>
                    ))}
                    ...
                    {services.map((amenity) => (
                      <div key={amenity.id} className="flex items-start">
                        ...
                        <div>
                          <span className="text-sm font-medium text-gray-900">{amenity.label}</span>
                          <p className="text-xs text-gray-600 mt-1">
                            {amenity.id === 'beach_bar' && 'Beachside bar serving drinks and light refreshments'}
                            {amenity.id === 'taverna' && 'Traditional Greek restaurant serving local cuisine'}
                            {amenity.id === 'food' && 'Food and beverage options available at or near the beach'}
                            {amenity.id === 'music' && 'Music entertainment or background music at the beach'}
                          </p>
                        </div>
                      </div>
                    ))}
                    ...
                    {activities.map((amenity) => (
                      <div key={amenity.id} className="flex items-start">
                        ...
                        <div>
                          <span className="text-sm font-medium text-gray-900">{amenity.label}</span>
                          <p className="text-xs text-gray-600 mt-1">
                            {amenity.id === 'snorkeling' && 'Underwater exploration with snorkeling gear'}
                            {amenity.id === 'water_sports' && 'Water-based recreational activities (jet skiing, windsurfing, etc.)'}
                            {amenity.id === 'family_friendly' && 'Suitable and safe environment for families with children'}
                            {amenity.id === 'boat_trips' && 'Boat excursions and tours departing from the beach'}
                            {amenity.id === 'fishing' && 'Fishing activities permitted or fishing spots available'}
                            {amenity.id === 'photography' && 'Scenic views and photo opportunities'}
                            {amenity.id === 'hiking' && 'Hiking trails accessible from or near the beach'}
                            {amenity.id === 'birdwatching' && 'Bird watching opportunities in the area'}
                            {amenity.id === 'cliff_jumping' && 'Cliff jumping or diving opportunities available'}
                          </p>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Data collected from public sources, pending verification</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Timestamp when the beach record was first created</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900">Updated At</h4>
                    <p className="text-gray-600 text-sm">Timestamp of the most recent data update</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900">Verified At</h4>
                    <p className="text-gray-600 text-sm">Timestamp of last verification (if applicable)</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Current status: Active, Pending, or Archived</p>
                  </div>
                </div>
              </div>
            </section>
