      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto prose prose-lg dark:prose-invert prose-headings:text-foreground prose-p:text-muted-foreground prose-li:marker:text-primary prose-a:text-primary hover:prose-a:underline prose-a:no-underline">
            ...
            <p>
              We value your privacy. This page explains which technologies are strictly necessary
              for the website to function and how our optional analytics work.
            </p>

            <h2>Strictly necessary (always on)</h2>
            <p>
              These technologies are essential for core functionality and are not used for
            ...
            <ul>
              ...
              <li>
                Local storage for consent choice (<code>analytics_consent</code>) so your preference
                persists
              </li>
              <li>
                Supabase authentication session (admin area only) - session cookies are only set
                when accessing admin features
              </li>
            ...
            <h3>What we track</h3>
            <p>
              When enabled, we track page views and usage to measure traffic and content
              performance. Our analytics implementation is documented in{" "}
              <code>src/lib/analytics.ts</code> and uses events to record key actions (e.g., search
            ...
            <ul>
              ...
              <li>
                Technical metadata like browser, operating system, device type, viewport size, and
                language
              </li>
              <li>UTM parameters for campaign attribution when present</li>
              <li>
                Approximate location derived from IP at request time for aggregated statistics; IP
                addresses are not stored by our implementation
              </li>
            </ul>
            ...
            <p>
              You can change your analytics preference at any time by clicking the{" "}
              <em>Privacy preferences</em> link in the site footer. Turning analytics off will stop
              further analytics events from being sent.
            </p>
            ...
            <p>
              The data controller is Beaches of Greece. Umami Cloud provides analytics services as
              our data processor.
            </p>

            <h2>International transfers</h2>
            <p>
              Depending on your location and service infrastructure, analytics data may be processed
              outside your country. We rely on appropriate safeguards offered by our service
              providers.
            </p>
