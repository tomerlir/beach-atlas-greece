...
const ImportExport: React.FC = () => {
  ...
  const columnOrder =
    "slug,name,area,latitude,longitude,type,wave_conditions,organized,parking,blue_flag,amenities,photo_url,description,source,verified_at,status";
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Required column order and data format for import/export</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              ...
              <div className="relative bg-muted p-3 rounded-md font-mono text-xs overflow-x-auto">
                <div className="whitespace-nowrap pr-8">{columnOrder}</div>
                <Button
                  variant="ghost"
                  size="sm"
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <ul className="text-sm space-y-1 text-muted-foreground">
                  <li>
                    • <strong>Booleans:</strong> true|false (case-insensitive)
                  </li>
                  <li>
                    • <strong>Numbers:</strong> latitude (-90 to 90), longitude (-180 to 180)
                  </li>
                  <li>
                    • <strong>Dates:</strong> ISO format (YYYY-MM-DDTHH:mm:ssZ) or empty
                  </li>
                  <li>
                    • <strong>Amenities:</strong> comma-separated keys
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm space-y-1 text-muted-foreground">
                  <li>
                    • <strong>type:</strong> SANDY|PEBBLY|MIXED|OTHER
                  </li>
                  <li>
                    • <strong>wave_conditions:</strong> CALM|MODERATE|WAVY|SURFABLE
                  </li>
                  <li>
                    • <strong>parking:</strong> NONE|ROADSIDE|SMALL_LOT|LARGE_LOT
                  </li>
                  <li>
                    • <strong>status:</strong> ACTIVE|HIDDEN|DRAFT
                  </li>
                </ul>
              </div>
            </div>
