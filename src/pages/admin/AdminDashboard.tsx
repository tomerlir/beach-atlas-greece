        ...
        <TabsContent value="beaches" className="space-y-6 animate-in fade-in-50 duration-300">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">Active beaches in directory</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">With facilities</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">Certified beaches</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">Islands & regions</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>Latest changes to the beaches directory</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
