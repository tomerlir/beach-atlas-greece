    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            aria-label="Filter organized"
            className="border rounded px-2 py-1"
            value={organized}
            onChange={(e) => setParam("organized", e.target.value)}
          >
            ...
            {items.map((b) => (
              <tr key={b.id} className="border-b last:border-0 align-top">
                <td className="py-2 pr-2 font-medium text-foreground">
                  <Link to={`/admin/beaches/${b.id}`} className="underline underline-offset-2">
                    {b.name}
                  </Link>
                </td>
                ...
                <td className="py-2 pr-2 whitespace-nowrap">
                  {formatRelativeUpdatedAt(b.updated_at)}
                </td>
                <td className="py-2 pr-2">
                  <div className="flex items-center gap-2">
        ...
        {items.map((b) => (
          <Card key={b.id} className="p-3">
            ...
            <div className="mt-3 flex gap-2">
              <Link to={`/admin/beaches/${b.id}`} className="w-full">
