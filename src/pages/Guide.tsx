...
const Guide = () => {
  ...
  const seoDescription = "Step-by-step guide to selecting the right Greek beach based on waves, sand type, amenities, parking, and accessibility. Includes examples and pro tips.";
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative h-[30vh] flex items-center justify-center bg-gradient-ocean overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Beach Selection Guide</h1>
            <p className="text-lg md:text-xl drop-shadow-lg opacity-90">A quick, practical way to find your perfect Greek beach</p>
          </div>
        </section>
        ...
        <main className="container mx-auto px-4 py-12">
              ...
              <CardContent className="p-6 md:p-8">
                <div className="flex items-start md:items-center gap-4 md:gap-6 flex-col md:flex-row">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-2">A simple plan for the perfect beach</h2>
                    <p className="text-muted-foreground leading-relaxed">Follow these quick steps to match your vibe, conditions, and must-have amenities across Greece. It takes less than five minutes.</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-card/80">~5 min</Badge>
                    <Badge variant="outline" className="bg-card/80">Beginner friendly</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="max-w-5xl mx-auto mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="relative overflow-hidden border-0 bg-card shadow-soft">
              ...
              <CardContent className="relative p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-lg bg-ocean text-white flex items-center justify-center shadow-medium">1</div>
                  <h3 className="font-semibold text-lg m-0">Pick your vibe & type</h3>
                </div>
                <div className="flex items-start gap-3 text-muted-foreground">
                  <Star className="h-5 w-5 mt-0.5 text-ocean" />
                  <p>Choose <strong>sandy</strong> for comfort, <strong>pebbly</strong> for crystal waters, or <strong>mixed</strong>. Prefer <strong>organized</strong> (amenities) vs <strong>unorganized</strong> (natural).</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden border-0 bg-card shadow-soft">
              ...
              <CardContent className="relative p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-lg bg-ocean text-white flex items-center justify-center shadow-medium">2</div>
                  <h3 className="font-semibold text-lg m-0">Set waves & wind</h3>
                </div>
                <div className="flex items-start gap-3 text-muted-foreground">
                  <Waves className="h-5 w-5 mt-0.5 text-ocean" />
                  <p>Families choose <em>calm</em>. Adventurous swimmers try <em>wavy</em> or <em>surfable</em>. Conditions change with weather.</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden border-0 bg-card shadow-soft">
              ...
              <CardContent className="relative p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-lg bg-ocean text-white flex items-center justify-center shadow-medium">3</div>
                  <h3 className="font-semibold text-lg m-0">Parking & access</h3>
                </div>
                <div className="flex items-start gap-3 text-muted-foreground">
                  <Car className="h-5 w-5 mt-0.5 text-ocean" />
                  <p>Filter by <strong>parking</strong> availability and check <strong>accessibility</strong> options when needed.</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden border-0 bg-card shadow-soft">
              ...
              <CardContent className="relative p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-lg bg-ocean text-white flex items-center justify-center shadow-medium">4</div>
                  <h3 className="font-semibold text-lg m-0">Choose area or Near Me</h3>
                </div>
                <div className="flex items-start gap-3 text-muted-foreground">
                  <MapPin className="h-5 w-5 mt-0.5 text-ocean" />
                  <p>Pick an island/region or use <strong>Near Me</strong> to sort by distance instantly.</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden border-0 bg-card shadow-soft">
              ...
              <CardContent className="relative p-6">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-9 w-9 rounded-lg bg-ocean text-white flex items-center justify-center shadow-medium">5</div>
                  <h3 className="font-semibold text-lg m-0">Refine amenities</h3>
                </div>
                <div className="flex items-start gap-3 text-muted-foreground">
                  <Shield className="h-5 w-5 mt-0.5 text-ocean" />
                  <p>Add <strong>lifeguard</strong>, <strong>beach bar</strong>, <strong>showers</strong>, or <strong>Blue Flag</strong> as priorities.</p>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="border-0 bg-card shadow-soft">
              <CardContent className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="px-3 py-1 bg-muted/50">calm sandy beach with umbrellas in Corfu</Badge>
                  <Badge variant="outline" className="px-3 py-1 bg-muted/50">unorganized beach with clear water near Naxos</Badge>
                  <Badge variant="outline" className="px-3 py-1 bg-muted/50">Blue Flag beach with parking in Crete</Badge>
                  <Badge variant="outline" className="px-3 py-1 bg-muted/50">family-friendly beach with lifeguard in Rhodes</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="border-0 bg-card shadow-soft">
              <CardContent className="p-6">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <li className="flex items-start gap-2 text-muted-foreground"><MapPin className="h-4 w-4 mt-1 text-ocean" />Use the map to compare nearby options visually.</li>
                  <li className="flex items-start gap-2 text-muted-foreground"><Car className="h-4 w-4 mt-1 text-ocean" />Arrive early for easier parking at popular beaches.</li>
                  <li className="flex items-start gap-2 text-muted-foreground"><Waves className="h-4 w-4 mt-1 text-ocean" />Check wind/wave forecasts for sensitive choices.</li>
                </ul>
              </CardContent>
            </Card>
          </div>
